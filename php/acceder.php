...
<html lang="es">
  ...
  <body>
    ...
    <!-- Menú de navegación -->
    <nav class='menu navbar navbar-custom navbar-fixed-top texto'>
          <div class='container-fluid'>
            ...
            <ul class='nav navbar-nav navbar-right'>
              ...
              <li><a href='http://localhost/web-inmobiliaria/acceder.php'><span class='glyphicon glyphicon-log-in'></span> Acceder</a></li>
            </ul>
            </div>
          </div>
    </nav>
